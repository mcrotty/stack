...
class CDAPProvider : public CDAPProviderInterface
{
 public:
        ...
        ~CDAPProvider();
        cdap_rib::con_handle_t open_connection(
        ...
        int close_connection(unsigned int port);
        ...
        void open_connection_response(const cdap_rib::con_handle_t &con,
                                      const cdap_rib::res_info_t &res,
                                      int message_id);
        void close_connection_response(unsigned int port,
                                       const cdap_rib::flags_t &flags,
                                       const cdap_rib::res_info_t &res,
                                       int message_id);
        void remote_create_response(unsigned int port,
                                    const cdap_rib::obj_info_t &obj,
                                    const cdap_rib::flags_t &flags,
                                    const cdap_rib::res_info_t &res,
                                    int message_id);
        void remote_delete_response(unsigned int port,
                                    const cdap_rib::obj_info_t &obj,
                                    const cdap_rib::flags_t &flags,
                                    const cdap_rib::res_info_t &res,
                                    int message_id);
        void remote_read_response(unsigned int port,
                                  const cdap_rib::obj_info_t &obj,
                                  const cdap_rib::flags_t &flags,
                                  const cdap_rib::res_info_t &res,
                                  int message_id);
        void remote_cancel_read_response(unsigned int port,
                                         const cdap_rib::flags_t &flags,
                                         const cdap_rib::res_info_t &res,
                                         int message_id);
        void remote_write_response(unsigned int port,
                                   const cdap_rib::flags_t &flags,
                                   const cdap_rib::res_info_t &res,
                                   int message_id);
        void remote_start_response(unsigned int port,
                                   const cdap_rib::obj_info_t &obj,
                                   const cdap_rib::flags_t &flags,
                                   const cdap_rib::res_info_t &res,
                                   int message_id);
        void remote_stop_response(unsigned int port,
                                  const cdap_rib::flags_t &flags,
                                  const cdap_rib::res_info_t &res,
                                  int message_id);
...
int CDAPProvider::close_connection(unsigned int port)
{
        int invoke_id;
        const cdap_m_t *m_sent;
...
void CDAPProvider::close_connection_response(unsigned int port,
                                             const cdap_rib::flags_t &flags,
                                             const cdap_rib::res_info_t &res,
                                             int message_id)
{
...
void CDAPProvider::remote_create_response(unsigned int port,
                                          const cdap_rib::obj_info_t &obj,
                                          const cdap_rib::flags_t &flags,
                                          const cdap_rib::res_info_t &res,
                                          int message_id)
...
void CDAPProvider::remote_delete_response(unsigned int port,
                                          const cdap_rib::obj_info_t &obj,
                                          const cdap_rib::flags_t &flags,
                                          const cdap_rib::res_info_t &res,
                                          int message_id)
...
void CDAPProvider::remote_read_response(unsigned int port,
                                        const cdap_rib::obj_info_t &obj,
                                        const cdap_rib::flags_t &flags,
                                        const cdap_rib::res_info_t &res,
                                        int message_id)
...
void CDAPProvider::remote_cancel_read_response(unsigned int port,
                                               const cdap_rib::flags_t &flags,
                                               const cdap_rib::res_info_t &res,
                                               int message_id)
{
        ...
        // FIXME change cdap_rib::flags_t::NONE_FLAGS
        (void) flags;
        m_sent = manager_->getCancelReadResponseMessage(flags, res, message_id);
        send(m_sent, port);

        delete m_sent;
}
void CDAPProvider::remote_write_response(unsigned int port,
                                         const cdap_rib::flags_t &flags,
                                         const cdap_rib::res_info_t &res,
                                         int message_id)
{
...
void CDAPProvider::remote_start_response(unsigned int port,
                                         const cdap_rib::obj_info_t &obj,
                                         const cdap_rib::flags_t &flags,
                                         const cdap_rib::res_info_t &res,
                                         int message_id)
...
void CDAPProvider::remote_stop_response(unsigned int port,
                                        const cdap_rib::flags_t &flags,
                                        const cdap_rib::res_info_t &res,
                                        int message_id)
{
        ...
        // FIXME change cdap_rib::flags_t::NONE_FLAGS
        (void) flags;
        m_sent = manager_->getStopObjectResponseMessage(flags, res, message_id);
        send(m_sent, port);
                                   ...
                                   unsigned int port)
{
        ...
        switch (m_rcv->op_code_) {
                ...
                case cdap_m_t::M_RELEASE_R:
                        ...
                        break;
                case cdap_m_t::M_CREATE:
                        callback_->remote_create_request(con, obj, filt,
                                                         message_id);
                        break;
                case cdap_m_t::M_CREATE_R:
                        ...
                        break;
                case cdap_m_t::M_DELETE:
                        callback_->remote_delete_request(con, obj, filt,
                                                         message_id);
                        break;
                case cdap_m_t::M_DELETE_R:
                        ...
                        break;
                case cdap_m_t::M_READ:
                        callback_->remote_read_request(con, obj, filt,
                                                       message_id);
                        break;
                case cdap_m_t::M_READ_R:
                        ...
                        break;
                case cdap_m_t::M_CANCELREAD:
                        callback_->remote_cancel_read_request(con, obj, filt,
                                                              message_id);
                        break;
                case cdap_m_t::M_CANCELREAD_R:
                        ...
                        break;
                case cdap_m_t::M_WRITE:
                        callback_->remote_write_request(con, obj, filt,
                                                        message_id);
                        break;
                case cdap_m_t::M_WRITE_R:
                        ...
                        break;
                case cdap_m_t::M_START:
                        callback_->remote_start_request(con, obj, filt,
                                                        message_id);
                        break;
                case cdap_m_t::M_START_R:
                        ...
                        break;
                case cdap_m_t::M_STOP:
                        callback_->remote_stop_request(con, obj, filt,
                                                       message_id);
                        break;
                case cdap_m_t::M_STOP_R:
